...
import com.gura.spring05.exception.DoNotDeleteException;
...
public class CafeServiceImpl implements CafeService{
	...
	public void getDetail(HttpServletRequest request) {
		 ...
		 * 목적: 페이징에 맞는 List<CafeCommentDto>를 얻어오는 것.
		 * 			commentList
		 * 			startPageNum
		 * 			endPageNum
		 * 			pageNum
	...
	public void deleteContent(int num, HttpServletRequest request) {
		...
		if(!id.equals(dto.getWriter())) {
			throw new DoNotDeleteException("남의 글 지우기 없기!");
		}		
		cafeDao.delete(num);
	}
	...
	public void deleteComment(HttpServletRequest request) {
		...
		if(!writer.equals(id)) {
			throw new DoNotDeleteException("남의 댓글을 삭제할수 없습니다.");
		}
	...
	public void moreCommentList(HttpServletRequest request) {
		...
		commentDto.setStartRowNum(startRowNum);
		commentDto.setEndRowNum(endRowNum);
		commentDto.setRef_group(ref_group); //ref_group 번호도 담는다.
