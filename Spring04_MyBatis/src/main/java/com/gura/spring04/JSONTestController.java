...
public class JSONTestController {
	...
	/*
	 * 1. jackson-databind 라이브러리가 depenency에 명시가 되어 있고
	 * 2. servlet-context.xml에 <mvc:annotation-driven /> 이 명시 되어 있고
	 * 3. 컨트롤러의 메소드에 @ResponseBody 어노테이션이 붙어 있으면
	 * Map 객체에 담긴 내용이 json 문자열로 변환되어 응답한다.
	 * */
	...
	public MemberDto json07() {
		...
		/*
		 * jackson-data 라이브러리가 dto를 json으로 표현해준다.
		 * */
		return dto;
	}
